...
from .views import (
    ...
    DashboardBookingView,DashboardReviewView,ReviewDeleteView,WorkshopDeleteView
)
...
urlpatterns = [
    ...
    path("workshops/<int:pk>/delete/",WorkshopDeleteView.as_view(),name="delete_workshops"),
