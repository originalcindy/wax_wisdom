"""
Django settings for fictious_candle project.
...
# DEFAULT SUPERUSERER CREDENTIALS
SUPERADMIN_USERNAME = os.getenv('SUPERADMIN_USERNAME')
SUPERADMIN_EMAIL = os.getenv('SUPERADMIN_EMAILL')
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "candle.context_processors.company_info",
            ],
        },
    },
]
